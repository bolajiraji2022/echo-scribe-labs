    ...
    <section id="cta" className="relative bg-background py-12">
      <div className="container">
        <ScrollReveal className="text-center">
          <div className="bg-gradient-to-br from-blue-900/80 via-blue-800/50 to-transparent backdrop-blur-sm border border-border rounded-3xl px-8 py-10 max-w-2xl mx-auto">
          <ScrollReveal>
