...
const FAQ = () => {
  return (
    <section id="faq" className="w-full py-2 bg-background">
      ...
      <ScrollReveal delay={200} className="mx-auto w-full max-w-2xl bg-gradient-to-br from-card/20 via-card/15 to-card/10 backdrop-blur-sm border border-border rounded-3xl px-8 py-10 mb-16">
